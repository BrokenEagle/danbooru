...
class ArtistCommentariesControllerTest < ActionDispatch::IntegrationTest
  context "The artist commentaries controller" do
    setup do
      ...
      as(@user) do
        @post = create(:post, id: 999, tag_string: "hakurei_reimu", uploader_id: @user.id)
        @commentary = create(:artist_commentary, post: @post, original_title: "ot1", translated_title: "tt1")
