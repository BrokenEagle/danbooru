  ...
  context "The dmails controller" do
    ...
    context "index action" do
      setup do
        ...
        @deleted_dmail = create(:dmail, owner: @user, title: "UMAD", from: @user, is_deleted: true)
      ...
      context "using includes" do
        should respond_to_search(owner_id: 999).with { [@deleted_dmail, @received_dmail, @dmail] }
        should respond_to_search(owner_id: 1000).with { [] }
