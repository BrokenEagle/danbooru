...
class ModerationReportsControllerTest < ActionDispatch::IntegrationTest
  context "The moderation reports controller" do
    ...
    context "index action" do
      setup do
        @builder = create(:builder_user, name: "daiyousei", created_at: 2.weeks.ago)
        ...
        @dmail_report = create(:moderation_report, reason: "spam", model: @dmail, creator: @builder)
      end
      ...
      context "as a moderator" do
        ...
        should respond_to_search(reason_matches: "spam").with { [@dmail_report, @forum_report, @comment_report] }
