  ...
  context "The forum topics controller" do
    setup do
      ...
      as(@user) do
        ...
        create(:forum_post, creator: @user, topic: @forum_topic, body: "xxx")
      end
    end
    ...
    context "index action" do
      setup do
        ...
        @mod_topic = as(@mod) { create(:forum_topic, creator: @mod, min_level: User::Levels::MODERATOR) }
      ...
      context "with search conditions" do
        context "as a user" do
          setup do
            ...
            @sorted_topics = [@sticky_topic, @other_topic, @forum_topic].sort_by(&:updated_at)
          end
        ...
        context "as a moderator" do
          setup do
            ...
            @sorted_topics = [@sticky_topic, @other_topic, @mod_topic, @forum_topic].sort_by(&:updated_at)
          end
