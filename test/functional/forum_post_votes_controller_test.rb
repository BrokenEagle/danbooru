  ...
  context "The forum post votes controller" do
    setup do
      ...
      as(@user) do
        ...
        @forum_post = create(:forum_post, topic: @forum_topic, creator: @user)
    ...
    context "index action" do
      setup do
        @voter = create(:user, name: "rumia")
        @vote = as (@voter) { create(:forum_post_vote, forum_post: @forum_post, creator: @voter, score: 1) }
